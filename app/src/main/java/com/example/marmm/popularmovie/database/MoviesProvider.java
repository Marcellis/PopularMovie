...
public class MoviesProvider extends ContentProvider {
    ...
    */
        sURIMatcher.addURI(MoviesContract.AUTHORITY, MoviesContract.MovieEntry.TABLE_NAME, MOVIES);
        sURIMatcher.addURI(MoviesContract.AUTHORITY, MoviesContract.MovieEntry.TABLE_NAME + "/#", MOVIES_ID);
        return sURIMatcher;
    }
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case MOVIES_ID:
                ...
                tasksDeleted = db.delete(MoviesContract.MovieEntry.TABLE_NAME, "_id=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
            case MOVIES_ID:
                ...
                String id = uri.getPathSegments().get(1);
                //using selections
                tasksUpdated = dbHelper.getWritableDatabase().update(MoviesContract.MovieEntry.TABLE_NAME, values, "_id=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
